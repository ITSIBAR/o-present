...
//jadwal shift
$routes->get('/jadwal-shift', 'Jadwal::index', ['filter' => 'role:admin,pegawai,head']);
//ketidakhadiran
...
//kelola ketidak hadiran
$routes->get('/kelola-ketidakhadiran', 'Ketidakhadiran::kelolaKetidakhadiran', ['filter' => 'role:head,admin,pegawai']);
